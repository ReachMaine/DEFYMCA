...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
				<?php if ( 'post' == get_post_type() && false ) : /* zig - Xout by FALSE */  // Hide category and tag text for pages on Search ?>
			<?php
				/* translators: used between list items, there is a space after the comma */
				$categories_list = get_the_category_list( __( ', ', 'flatsome' ) );
			?>
		...
		<?php if ( 'post' == get_post_type()  ) : /* zig  lobotomize & moved.*/ ?>
		<div class="entry-meta">
			<?php defy_posted_on(); ?>
		</div><!-- .entry-meta -->
		<?php endif; ?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		<?php endif; // End if 'post' == get_post_type() ?>
		<h3 class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h3>
		<?php /* zig xout <div class="tx-div small"></div> */ ?>
